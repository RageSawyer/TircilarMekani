...
public DurumAyarla()
{
	...
	{
	    StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"LS_SF_D");
	    DurumDegistir(DURUM_S1_D);
	}else if(ODurum == DURUM_S1_D)
	{
		StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"LS-SF");
		DurumDegistir(DURUM_S1_S2);
	}else if(ODurum == DURUM_S1_S2)
	{
	    StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"SF_LS_D");
	    DurumDegistir(DURUM_S2_D);
	}else if(ODurum == DURUM_S2_D)
	{
		StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"SF-LS");
